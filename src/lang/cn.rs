...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Enable service", "允许服务"),
        ("Start service", "启动服务"),
        ("Service is running", "服新悦电脑远程协助持续服务中"),
        ...
        ("Connecting...", "正在连接..."),
        ("Connection in progress. Please wait.", "正在进行到新悦电脑服务器请稍候。"),
        ...
        ("Configure", "配置"),
        ("config_acc", "为了能够远程控制你的桌面, 请给予 新悦电脑 \"辅助功能\" 权限。"),
        ("config_screen", "为了能够远程访问你的桌面, 请给予 新悦电脑 \"屏幕录制\" 权限。"),
        ("Installing ...", "安装中..."),
        ("Install", "安装"),
        ("Installation", "安装"),
        ...
        ("android_input_permission_tip1", "为了让远程设备通过鼠标或触屏控制您的安卓设备，你需要允许 新悦电脑 使用\"无障碍\"服务。"),
        ...
        ("android_open_battery_optimizations_tip", "如需关闭此功能，请在接下来的 新悦电脑 应用设置页面中，找到并进入 [电源] 页面，取消勾选 [不受限制]"),
        ("Start on boot", "开机自启动"),
        ...
        ("still_click_uac_tip", "依然需要被控端用户在运行 新悦电脑 的 UAC 窗口点击确认。"),
        ...
        ("empty_favorite_tip", "电脑卡顿？运行慢？电脑硬件该升级了！\n联系我电脑该升级了！联系电话:17625370078 免费咨询"),
        ("empty_lan_tip", "电脑卡顿？运行慢？电脑硬件该升级了！\n联系我电脑该升级了！联系电话:17625370078 免费咨询"),
        ("empty_address_book_tip", "电脑卡顿？运行慢？电脑硬件该升级了！\n联系我电脑该升级了！联系电话:17625370078 免费咨询"),
        ("eg: admin", "例如：admin"),
        ("Empty Username", "空用户名"),
        ("Empty Password", "空密码"),
        ("Me", "我"),
        ...
        ("powered_by_me", "由 新悦电脑 提供支持"),
        ("outgoing_only_desk_tip", "当前版本的软件由新悦电脑定制。\n您可以连接至其他设备，但是其他设备无法连接至您的设备。"),
        ("preset_password_warning", "新悦电脑定制版本密码随机。 任何知晓此密码的人都能完全控制您的设备。如果这不是您所预期的，请立即卸载此软件。"),
        ("Security Alert", "安全警告"),
        ...
        ("allow-only-conn-window-open-tip", "仅当 新悦电脑远程协助 窗口打开时允许连接"),
        ...
        ("Floating window", "悬浮窗"),
        ("floating_window_tip", "有助于保持 新悦电脑远程协助 后台服务"),
